...
class AppTextStyles {
  ...
  static TextStyle get normalText => TextStyle(color: Colors.black ,  fontSize: 14, fontFamily: 'Montserrat',);

  static TextStyle get boldText => TextStyle(color: Colors.black ,  fontSize: 20, fontFamily: 'Montserrat',);
  ...
  */
  ...
  //     );
  //
  // static TextStyle get bold20Black => TextStyle(fontWeight: FontWeight.bold, fontSize: 20);
}
